        ...
        <div className="flex flex-col items-center">
          <div className="max-w-6xl mx-auto bg-light px-5 py-2 rounded mb-5 mt-4">
            <label className="text-main">
              You found{' '}
              {/*<label className='font-bold'>{uniqueUniv.length}</label> institutes and */}
              <label className="font-bold">{filterCourse.length}</label> courses
            </label>
          </div>
          <div className="max-w-6xl mx-auto bg-light px-5 py-3 rounded mb-5 ">
            {filterCourse && filterCourse.length > 0 ? (
              filterCourse.slice(0, n).map((data) => {
                    ...
                    <div className="col-span-2 sm:col-span-5">
                      ...
                      <ul className="text-2xs px-5 mt-3">
                        ...
                        <li className="flex flex-row items-center flex-wrap ">
                          ...
                          <label className="text text-2.5xs sm:ml-2">
                            Acceptance Rate
                          </label>
                          {/* <svg
                                                aria-hidden="true"
              ...
              >
                <svg
                  aria-hidden="true"
                  class="w-12 h-12 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 text-main"
                  viewBox="0 0 100 101"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
