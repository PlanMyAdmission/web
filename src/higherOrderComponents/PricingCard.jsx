            ...
            <div className="p-6 space-y-6">
              ...
              <div className="border-t pt-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-gray-700 text-sm sm:text-base">+91 88280 99194</span>
                  </div>
                  <div className="flex items-center space-x-3">
                    <svg className="w-5 h-5 text-main flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M18 10c0 3.866-3.582 7-8 7a8.841 8.841 0 01-4.083-.98L2 17l1.338-3.123C2.493 12.767 2 11.434 2 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM7 9H5v2h2V9zm8 0h-2v2h2V9zM9 9h2v2H9V9z" clipRule="evenodd" />
                    </svg>
                    <span className="text-gray-700 text-sm sm:text-base">WhatsApp: +91 88280 99194</span>
                  </div>
                </div>
              </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    onClick={() => window.open('https://wa.me/8828099194', '_blank')}
