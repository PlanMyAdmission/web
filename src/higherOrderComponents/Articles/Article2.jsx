    ...
    <>
      ...
      <div className="max-w-5xl mx-auto bg-transparent mx-auto my-3 mt-16 grid grid-cols-3 gap-2">
        <div className="w-full mx-auto bg-transparent mx-auto justify-center gap-2 p-5 col-span-3 md:col-span-2 flex flex-col">
          ...
          <p className="text-md pl-1">
            Look beyond the country's reputation and delve into the academic
            standing of individual universities. Explore university rankings,
            faculty expertise, and research output. A university's reputation is
            often a reflection of its commitment to academic excellence.
          </p>
          ...
          <p className="text-md pl-1">
            ...
            requirements of the programs you're interested in, and if necessary,
            invest time in language preparation courses.
          </p>
          ...
          <p className="text-md pl-1">
            ...
            expectations, campus resources, and cultural adaptation. It's also
            an excellent opportunity to meet fellow international students
          </p>
