    ...
    <>
      <div className="max-w-5xl mx-auto bg-light mx-auto px-5 p-10 rounded-xl my-5 mt-20 grid grid-cols-1 sm:grid-cols-2 justify-center items-center gap-7">
        ...
        <div className="col-span-1 text-4xl font-bold">
          <p>
            Navigating the American Campus | A Student's Guide to Living in the
            USA
          </p>
      ...
      <div className="max-w-5xl mx-auto bg-transparent mx-auto my-3 mt-16 grid grid-cols-3 gap-2">
        <div className="w-full mx-auto bg-transparent mx-auto justify-center gap-2 p-5 col-span-3 md:col-span-2 flex flex-col">
          <p className="text-2xl">
            ...
            journey through academia; it's an exploration of diverse cultures, a
            rendezvous with new friendships, and an immersion into a lifestyle
            shaped by opportunity and innovation. In this guide, we'll walk you
            through the essentials of student life in the USA, offering insights
            and tips for making the most of your time in this land of
            possibilities.
          </p>
          ...
          <p className="text-md pl-1">
            ...
            does not have a public healthcare system, so it's crucial to have
            insurance coverage. Most universities provide health insurance plans
            for international students, ensuring you have access to medical
