      ...
      <div className="max-w-5xl mx-auto bg-transparent mx-auto my-3 mt-16 grid grid-cols-3 gap-2">
        <div className="w-full mx-auto bg-transparent mx-auto justify-center gap-2 p-5 col-span-3 md:col-span-2 flex flex-col">
          ...
          <p className="text-md pl-1">
            Penn State's commitment to providing a comprehensive education is
            reflected in its vast array of academic programs. Whether you're
            drawn to liberal arts, engineering, business, health sciences, or
            information technology, Penn State offers a diverse range of
            undergraduate and graduate programs. This breadth allows students to
            explore their passions, fostering a well-rounded educational
            experience.
          </p>
          ...
          <p className="text-md pl-1">
            ...
            is no exception. The university's faculty comprises accomplished
            scholars, researchers, and industry experts dedicated to imparting
            knowledge and fostering critical thinking. Students have the
            privilege of learning from individuals at the forefront of their
            fields, ensuring a high-quality and intellectually stimulating
            education.
          </p>
          ...
          <p className="text-md pl-1">
            Penn State's commitment to research and innovation places it in the
            echelons of elite institutions. The university is home to numerous
            research centers and institutes, providing students with
          ...
          <p className="text-md pl-1">
            Penn State's commitment to global perspectives is evident in its
            diverse student body and international programs. The university
          ...
          <p className="text-md pl-1">
            Penn State's commitment to excellence extends to its facilities.
            Cutting-edge laboratories, libraries, and technology-equipped
            classrooms create an environment conducive to learning and research.
            The university's investment in modern infrastructure ensures that
            students have access to the tools and resources needed for academic
            success.
          </p>
          ...
          <p className="text-md pl-1">
            Penn State's rich traditions and spirited atmosphere contribute to a
            sense of pride and belonging. The iconic "We Are" chant and the
            Nittany Lion mascot symbolize the unity and resilience of the Penn
            State community. Engaging in these traditions fosters a strong sense
            of identity and camaraderie among students and alumni.
          </p>

          <p className="text-2xl font-bold mt-6">Philanthropic Impact</p>

          <p className="text-md pl-1">
            Penn State's commitment to making a positive impact extends beyond
            the campus. The university hosts THON, the largest student-run
            philanthropy globally, raising funds for pediatric cancer research
            and support. This commitment to philanthropy underscores the
            university's ethos of contributing to the betterment of society.
          </p>
          <p className="text-md pl-1">
            ...
            not just a university; it's a transformative journey. With a legacy
            built on innovation, global engagement, and a vibrant campus
