      ...
      <div className="max-w-5xl mx-auto bg-transparent mx-auto my-3 mt-16 grid grid-cols-3 gap-2">
        <div className="w-full mx-auto bg-transparent mx-auto justify-center gap-2 p-5 col-span-3 md:col-span-2 flex flex-col">
          ...
          <p className="text-md pl-1">
            ...
            average living costs in the city or town where you'll be studying.
            Urban centers generally have higher living expenses, so be sure to
          ...
          <p className="text-md pl-1">
            Don't overlook visa application fees and travel expenses. Visa fees
            vary by country, and travel costs depend on your location and the
            time of year. Include these expenses in your financial plan, and
          ...
          <p className="text-md pl-1">
            ...
            they can add up, so it's important to include them in your overall
            financial plan.
          </p>
          ...
          <p className="text-md pl-1">
            Build an emergency fund to cover unexpected expenses. Whether it's a
            medical emergency or an unplanned trip, having a financial safety
            net ensures you're prepared for unforeseen circumstances without
