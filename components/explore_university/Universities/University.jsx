...
import Navigator from '@/components/explore_university/Universities/Navigator.jsx';
...
const University = () => {
  ...
  useEffect(() => {
    ...
    if (payload?.udata) {
      const data = Array.isArray(payload.udata)
        ? payload.udata
        : [payload.udata];
      deferStateUpdate(() => setunData(data));
    } else {
              ...
              <div className="col-span-2 sm:col-span-3 self-center">
                <div className="flex flex-col flex-wrap">
                  ...
                  <div className="flex flex-row items-center text">
                    ...
                    <label className="text text-2xs sm:ml-2">
                      Acceptance Rate
                    </label>
                  </div>
                </div>
