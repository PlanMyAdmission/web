      ...
      <div>
        <h1 className="md:text-7xl text-5xl md:pl-0 pl-5 font-bold uppercase">
          ...
          <span className="text-main">
            ...
            {content?.accent || 'dreams into Life'}
          </span>
        </h1>
        ...
        <button
          className="bg-main px-5 py-2 text-white rounded-md block my-3 min-w-[150px] ml-5 md:ml-0 text-center font-semibold"
          onClick={() => {
            document
              .getElementById('institution-features')
