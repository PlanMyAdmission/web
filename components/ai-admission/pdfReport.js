        ...
        <div class="page">
          ...
          <div class="grid">
            <div class="card">
              ...
              <p><strong>Name:</strong> ${sanitize(`${profile.fullName || ''} ${profile.lastName || ''}`.trim() || 'Not provided')}</p>
            ...
            <div class="card">
              ...
              <div class="score">${evaluation.score ? `Overall Fit Score: ${sanitize(evaluation.score)}` : ''}</div>
            </div>
          </div>
