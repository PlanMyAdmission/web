    ...
    >
      {TAB_ITEMS.map((tab) => {
        ...
        return (
          ...
          >
            <span
              className={`inline-block py-2 px-4 mx-2 my-1 rounded-md transition-all duration-300 ${isActive ? 'bg-white text-main font-semibold shadow-md' : 'bg-light text-gray-700 hover:bg-white hover:text-main'}`}
            >
              {tab.name}
            </span>
          </Link>
