  ...
  return (
    <>
        ...
        >
          <div>
            ...
            <p className="text-sm text-gray-600">
              {exp.employement_type} • {exp.industry}
            </p>
      ...
      <form
        ...
        className="bg-white max-w-5xl mx-auto rounded-md shadow px-5 py-6 mb-6"
      >
        {experiences.map((input, index) => (
          <div key={index}>
            <div className="grid grid-cols-6 gap-6 mb-4">
              <div className="md:col-span-2 col-span-6">
                ...
                <input
                  ...
                  className="bg-light w-full p-2 rounded-sm border border-gray-300 outline-none"
                  required
                />
              </div>
              ...
              <div className="md:col-span-2 col-span-6">
                <label htmlFor="employement_type" className={labelStyle}>
            ...
            <div className="flex justify-end gap-3">
              <button
                type="submit"
                className="bg-darkBlue text-white px-5 py-2 rounded-sm hover:bg-blue-700 transition duration-150"
              >
                Save
              </button>
              <button
                ...
                className="bg-gray-200 px-5 py-2 rounded-sm hover:bg-gray-300 transition duration-150"
              >
                Cancel
              </button>
            </div>
