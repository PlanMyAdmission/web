...
export const ROUTE_META = {
  ...
  '/essay-review': {
    title: 'AI SOP & Essay Reviewer | Plan My Admission',
    description:
      'Rate your SOP, personal statement, or college essay with AI feedback, score breakdowns, and revision guidance.',
    sitemap: {
      changeFrequency: 'weekly',
      priority: 0.8,
    },
