...
import { ADMIN_AUTH_PROVIDER, ADMIN_USERS_COLLECTION } from '@lib/adminAuth.js';
import {
...
export const requireFirebaseAdmin = () => {
  if (!isFirebaseAdminConfigured) {
    throw new AdminApiError(
      'Firebase Admin is not configured. Add service account env vars locally, or run the app on Firebase App Hosting with default credentials enabled.',
      503,
    );
  }
};
